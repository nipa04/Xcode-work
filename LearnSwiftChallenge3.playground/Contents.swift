...
class Library {
    ...
    var catalogue: [String : Book] = ["ORW":Book("1985", "George Orwell"),
        ...
        for (bookId,book) in catalogue {
            ...
            if book.title == title {
                ...
                if checkedOutBooks[bookId] == nil {
                  ...
                  return "Checked out bt name" + person!.name
            }
    ...
    func checkOut(_ bookId:String, _ person:Person) -> String {
        ...
        //
        // Returns "w and adds the bookId,person key-value pair if the book doesn't currently exist in the checkedOutbooks dictionary
        //
